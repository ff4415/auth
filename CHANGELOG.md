...
## [2.177.0](https://github.com/ff4415/auth/compare/v2.176.1...v2.177.0) (2025-06-26)
...
* Add custom claims from Keycloak user token ([#1917](https://github.com/ff4415/auth/issues/1917)) ([1365aaa](https://github.com/ff4415/auth/commit/1365aaa45569fc9e7c3497e744e0e80cf237d617))
...
* add support packages for end-to-end testing ([#2021](https://github.com/ff4415/auth/issues/2021)) ([269ddfe](https://github.com/ff4415/auth/commit/269ddfe18718ae74535f7227eb75f67667275140))
...
* hooks round 2 - remove indirection and simplify error handling ([#2025](https://github.com/ff4415/auth/issues/2025)) ([26e23f0](https://github.com/ff4415/auth/commit/26e23f05acd1e1a959c3e04764a569ea0364d947))
* hooks round 4 - update tests to use require package ([#2030](https://github.com/ff4415/auth/issues/2030)) ([aaf93df](https://github.com/ff4415/auth/commit/aaf93df50ebfb489c6335e2c1b846dc5cee18767))
* hooks round 5 (Option 2) - add before-user-created hook ([#2034](https://github.com/ff4415/auth/issues/2034)) ([b53f6b0](https://github.com/ff4415/auth/commit/b53f6b0d0e056bf3e84884847ab4608ffc9efd61))
...
* make error message in factor creation more obvious ([#1374](https://github.com/ff4415/auth/issues/1374)) ([74af993](https://github.com/ff4415/auth/commit/74af9934c8e919ddf22a98996736d30c829fe01e))
...
* send over user in SendSMS Hook instead of UserID ([#1551](https://github.com/ff4415/auth/issues/1551)) ([d4d743c](https://github.com/ff4415/auth/commit/d4d743c2ae9490e1b3249387e3b0d60df6913c68))
...
* Vercel marketplace OIDC ([#1731](https://github.com/ff4415/auth/issues/1731)) ([a9ff361](https://github.com/ff4415/auth/commit/a9ff3612196af4a228b53a8bfb9c11785bcfba8d))
...
* accept ID tokens from all `account.apple.com` and `appleid.apple.com` ([#2050](https://github.com/ff4415/auth/issues/2050)) ([82aa167](https://github.com/ff4415/auth/commit/82aa167cae01658b5319914f3412d78876955106))
...
* allow HTTP with localhost in solana ([#2027](https://github.com/ff4415/auth/issues/2027)) ([3ee02f0](https://github.com/ff4415/auth/commit/3ee02f085df206dcd3e6fa79f2d583148ebc52b8))
...
* amr claim should contain provider_id for sso method ([#2033](https://github.com/ff4415/auth/issues/2033)) ([33741e1](https://github.com/ff4415/auth/commit/33741e18d2e0adb691e650355337924f9ccfd91f))
...
* apply shared limiters before email / sms is sent ([#1748](https://github.com/ff4415/auth/issues/1748)) ([bf276ab](https://github.com/ff4415/auth/commit/bf276ab49753642793471815727559172fea4efc))
...
* email-sendhook - bug in email change verification ([#2044](https://github.com/ff4415/auth/issues/2044)) ([be20654](https://github.com/ff4415/auth/commit/be20654ec3af21b93a8d7482a5673b5c8c60ac8a))
...
* enforce authorized address checks on send email only ([#1806](https://github.com/ff4415/auth/issues/1806)) ([c0c5b23](https://github.com/ff4415/auth/commit/c0c5b23728c8fb633dae23aa4b29ed60e2691a2b))
...
* improve token OIDC logging ([#1606](https://github.com/ff4415/auth/issues/1606)) ([5262683](https://github.com/ff4415/auth/commit/526268311844467664e89c8329e5aaee817dbbaf))
...
* new `odic.Provider` for apple with insecure issuer url context ([#2055](https://github.com/ff4415/auth/issues/2055)) ([23d69f1](https://github.com/ff4415/auth/commit/23d69f1c450b4a24a262cb25112e68408857a3b2))
...
* possible panic if refresh token has a null session_id ([#1822](https://github.com/ff4415/auth/issues/1822)) ([a7129df](https://github.com/ff4415/auth/commit/a7129df4e1d91a042b56ff1f041b9c6598825475))
...
* skip apple oidc issuer check ([#2053](https://github.com/ff4415/auth/issues/2053)) ([1c6f18e](https://github.com/ff4415/auth/commit/1c6f18e6e573ae1da6875f51d8613992ced057a2))
...
* treat `GOTRUE_MFA_ENABLED` as meaning TOTP enabled on enroll and verify ([#1694](https://github.com/ff4415/auth/issues/1694)) ([8015251](https://github.com/ff4415/auth/commit/8015251400bd52cbdad3ea28afb83b1cdfe816dd))
